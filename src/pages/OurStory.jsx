      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="mt-10 space-y-10">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start" data-aos="fade-right">
            <div className="w-20 h-20 bg-yellow-500 text-white flex items-center justify-center rounded-full text-xl font-bold">2010</div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-start" data-aos="fade-left">
            <div className="w-20 h-20 bg-yellow-500 text-white flex items-center justify-center rounded-full text-xl font-bold">2015</div>
          ...
          {/* Timeline Item 3 */}
          <div className="flex flex-col md:flex-row items-center md:items-start" data-aos="fade-right">
            <div className="w-20 h-20 bg-yellow-500 text-white flex items-center justify-center rounded-full text-xl font-bold">2020</div>
            <div className="ml-6 mt-4 md:mt-0 text-gray-700">
